...
const t = (t) => "[object Object]" === Object.prototype.toString.call(t),
	...
	a = (t, s, a) =>
		e("li", { class: t, html: `<a href="#" data-page="${s}">${a}</a>` }),
	i = (t, e) => {
		let s, a;
		1 === e
			? ((s = 0), (a = t.length))
...
class o {
	...
	render(t) {
		...
		if (
			...
			s.header || (this.head && this.table.removeChild(this.table.tHead)),
			s.footer
				? this.head &&
				  !this.foot &&
	...
	paginate() {
		...
		return (
			this.searching &&
				((e = []), this.searchData.forEach((t) => e.push(this.activeRows[t]))),
			this.options.paging
				? (this.pages = e
	...
	export(e) {
		...
		if (o.type) {
			if (
				(("txt" !== o.type && "csv" !== o.type) || (a[0] = this.header),
				o.selection)
			)
				...
				if ("txt" === o.type || "csv" === o.type) {
					...
					for (l = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++)
						!o.skipColumn.includes(s[n].originalCellIndex) &&
							...
							(l += `\`${s[n].textContent}\`,`);
					for (
						l = l.trim().substring(0, l.length - 1), l += ") VALUES ", n = 0;
						n < a.length;
						n++
					) {

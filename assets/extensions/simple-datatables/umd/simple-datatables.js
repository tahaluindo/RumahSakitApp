								...
								if (n)
									switch (n) {
										case "ISO_8601":
											...
											break;
										case "RFC_2822":
											r = e(t, "ddd, MM MMM YYYY HH:mm:ss ZZ").format(
												"YYYYMMDD"
											);
											break;
										case "MYSQL":
					...
					class o {
						...
						render(t) {
							...
							if (
								...
								this.body ||
									((this.body = e("tbody")), this.table.appendChild(this.body)),
							...
							if (
								...
								s.scrollY.length
									...
									: (a += "<div class='dataTable-container'></div>"),
						...
						renderPager() {
							if ((s(this.pagers), this.totalPages > 1)) {
								...
								this.options.firstLast &&
									s.appendChild(a(t, 1, this.options.firstText)),
									this.options.nextPrev &&
										s.appendChild(a(t, i, this.options.prevText));
								let h = this.links;
								this.options.truncatePager &&
									...
									this.links[this.currentPage - 1].classList.add("active"),
									this.options.nextPrev &&
										s.appendChild(a(t, n, this.options.nextText)),
									this.options.firstLast &&
										s.appendChild(a(t, this.totalPages, this.options.lastText)),
									...
									if ("txt" === o.type || "csv" === o.type) {
										...
										for (h = 0; h < a.length; h++)
											for (i[h] = i[h] || {}, n = 0; n < s.length; n++)
												!o.skipColumn.includes(s[n].originalCellIndex) &&
													this.columns(s[n].originalCellIndex).visible() &&
													(i[h][s[n].textContent] = a[h].cells[n].textContent);
						...
						import(e) {
							...
							if (a.data.length || t(a.data)) {
								if ("csv" === a.type) {
									...
									t.length &&
										(a.headings &&
											((s.headings = t[0].split(a.columnDelimiter)), t.shift()),
										t.forEach((t, e) => {
											s.data[e] = [];

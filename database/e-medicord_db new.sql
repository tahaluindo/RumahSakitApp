...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Des 2022 pada 17.36
...
(1, 'Electronic Medical Record Puskesmas Mekar Kota Kendari', 'e-medicord', 'Muh. Fadjrul Falakh', '(0401) 3081469', 'puskesmasmekar@yahoo.com', 'Jl. Laremba Komp. RCTI Kadia', 'medicord120221125111342.svg', 'clouds.jpeg', 'https://instagram.com/uptd_pmekar/', 'https://facebook.com/promkesasryana', 'https://www.youtube.com/channel/UCMJWK7WQ3DsW_veIdwk-SCg', 'Ini adalah aplikasi rekam medis puskesmas mekar kota kendari', 'medicordcrypto11', '131211100b0a090803020100', '2022-10-01 15:22:31');
...
--
ALTER TABLE `tbl_log`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=869;

--
-- AUTO_INCREMENT untuk tabel `tbl_pasien`
--
ALTER TABLE `tbl_pasien`
  MODIFY `pasien_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

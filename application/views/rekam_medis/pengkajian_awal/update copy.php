                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart("pengkajian_awal/update")?>
                                    <form class="form">
                                                            ...
                                                            <?php
                                                                foreach($pegawai as $pe){
                                                                    if($pengkajian_awal[0]->pegawai_id == $pe->pegawai_id){
                                                                        echo '<option value="'.$pe->pegawai_id.'" selected>'.$pe->nama_pegawai.' | '.$pe->keterangan.'</option>';
                                                                    }else{
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" id="alerrgi" class="form-control input-border-bottom" name="alergi" value="<?php echo $pengkajian_awal[0]->alergi; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="riwayat_penyakit" class="form-control input-border-bottom" name="riwayat_penyakit" value="<?php echo $pengkajian_awal[0]->riwayat_penyakit; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="riwayat_pengobatan" class="form-control input-border-bottom" name="riwayat_pengobatan" value="<?php echo $pengkajian_awal[0]->riwayat_pengobatan; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="riwayat_penyakit_keluarga" class="form-control input-border-bottom" name="riwayat_penyakit_keluarga" value="<?php echo $pengkajian_awal[0]->riwayat_penyakit_keluarga; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-4 table-responsive">
                                            <table cellpadding="5" class="table-borderless border-start border-end border-top border-bottom">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="kesadaran_fisik" class="form-control input-border-bottom" name="kesadaran_fisik" value="<?php echo $pengkajian_awal[0]->kesadaran_fisik; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="gcs">GCS</label>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="gcs" class="form-control input-border-bottom" name="gcs" value="<?php echo $pengkajian_awal[0]->gcs; ?>">
                                                    </td>
                                                    <td>
                                                        <?php
                                                            if ($pengkajian_awal[0]->masalah_fisik != '') {
                                                                $mf = 'hipotermi';
                                                                if ($mf == $pengkajian_awal[0]->masalah_fisik) {
                                                                    echo '<input type="checkbox" class="form-check-input form-check-primary form-check-glow" name="masalah_fisik[]" value="hipotermi" id="hipotermi" checked>
                                                                    <label class="form-check-label" for="hipotermi">hipotermi</label>';
                                                                } else {
                                                                    echo '<input type="checkbox" class="form-check-input form-check-primary form-check-glow" name="masalah_fisik[]" value="hipotermi" id="hipotermi">
                                                                    <label class="form-check-label" for="hipotermi">hipotermi</label>';
                                                                }
                                                            } else {
                                                                explode(' ',$pengkajian_awal[0]->masalah_fisik);
                                                                $mf = 'hipotermi';
                                                                if ($mf == $pengkajian_awal[0]->masalah_fisik) {
                                                                    echo '<input type="checkbox" class="form-check-input form-check-primary form-check-glow" name="masalah_fisik[]" value="hipotermi" id="hipotermi" checked>
                                                                    <label class="form-check-label" for="hipotermi">hipotermi</label>';
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="tekanan_darah" class="form-control input-border-bottom" name="tekanan_darah" value="<?php echo $pengkajian_awal[0]->tekanan_darah; ?>" aria-label="mmHg"><span class="input-group-text">mmHg</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="frekuensi_nadi" class="form-control input-border-bottom" name="frekuensi_nadi" value="<?php echo $pengkajian_awal[0]->frekuensi_nadi; ?>" aria-label="x/mnt"><span class="input-group-text">x/mnt</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            explode('',$pengkajian_awal[0]->masalah_fisik);
                                                            $mf2 = 'hipetermi';
                                                            if ($mf2 == $pengkajian_awal[0]->masalah_fisik) {
                                                                echo '<input type="checkbox" class="form-check-input form-check-primary form-check-glow" name="masalah_fisik[]" value="hipetermi" id="hipetermi" checked>
                                                                <label class="form-check-label" for="hipetermi">hipetermi</label>';
                                                            } else {
                                                                echo '<input type="checkbox" class="form-check-input form-check-primary form-check-glow" name="masalah_fisik[]" value="hipetermi" id="hipetermi">
                                                                <label class="form-check-label" for="hipetermi">hipetermi</label>';
                                                            }
                                                        ?>
                                                    </td>
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="frekuensi_nafas" class="form-control input-border-bottom" name="frekuensi_nafas" value="<?php echo $pengkajian_awal[0]->frekuensi_nafas; ?>" aria-label="x/mnt"><span class="input-group-text">x/mnt</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="produksi_urin" class="form-control input-border-bottom" name="produksi_urin" value="<?php echo $pengkajian_awal[0]->produksi_urin; ?>" aria-label="cc/hr"><span class="input-group-text">cc/hr</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="bak" class="form-control input-border-bottom" name="bak" value="<?php echo $pengkajian_awal[0]->bak; ?>" aria-label="x/hr"><span class="input-group-text">x/hr</span>
                                                        </div>
                                                    </td>
                                                    <td class="border-start">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <input type="text" id="warna_urin" class="form-control input-border-bottom" name="warna_urin" value="<?php echo $pengkajian_awal[0]->warna_urin; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="bau_urin">Bau : </label>
                                                    </td>
                                                    <td>
                                                            <input type="text" id="bau_urin" class="form-control input-border-bottom" name="bau_urin" value="<?php echo $pengkajian_awal[0]->bau_urin; ?>">
                                                    </td>
                                                    <td class="border-start"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control input-border-bottom" name="abdomen[]" value="<?php echo $pengkajian_awal[0]->abdomen; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="bab" class="form-control input-border-bottom" name="bab" value="<?php echo $pengkajian_awal[0]->bab; ?>" aria-label="x/hr"><span class="input-group-text">x/hr</span>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="frekuensi_diet" class="form-control input-border-bottom" name="frekuensi_diet" value="<?php echo $pengkajian_awal[0]->frekuensi_diet; ?>" aria-label="x/hr"><span class="input-group-text">x/hr</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" id="jml_frekuensi_diet" class="form-control input-border-bottom" name="jml_frekuensi_diet" value="<?php echo $pengkajian_awal[0]->jml_frekuensi_diet; ?>" aria-label="Kal."><span class="input-group-text">Kal.</span>
                                                        </div>
                                                    </td>
                                                    <td class="border-start"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="patah" class="form-control input-border-bottom" name="patah_tulang" value="<?php echo $pengkajian_awal[0]->patah_tulang; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="eks" class="form-control input-border-bottom" name="eks_fiksasi[]" value="<?php echo $pengkajian_awal[0]->eks_fiksasi; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="luka" class="form-control input-border-bottom" name="eks_fiksasi[]" value="<?php echo $pengkajian_awal[0]->eks_fiksasi; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="nyeri_e" class="form-control input-border-bottom" name="eks_fiksasi[]" value="<?php echo $pengkajian_awal[0]->eks_fiksasi; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td class="border-start">
                                                        <div class="input-group">
                                                            <input type="checkbox" class="form-check-input form-check-primary form-check-glow">
                                                            <input type="text" class="form-control input-border-bottom" name="masalah_muskuloskeletal[]" value="<?php echo $pengkajian_awal[0]->masalah_muskuloskeletal; ?>">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="penis" class="form-control input-border-bottom" name="penis" value="<?php echo $pengkajian_awal[0]->penis; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <label for="Scrotum">Scrotum</label>
                                                            <input type="text" id="Scrotum" class="form-control input-border-bottom" name="scrotum" value="<?php echo $pengkajian_awal[0]->scrotum; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <label for="Testis">Testis</label>
                                                            <input type="text" id="Testis" class="form-control input-border-bottom" name="testis" value="<?php echo $pengkajian_awal[0]->testis; ?>">
                                                        </div>
                                                    </td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="Vagina" class="form-control input-border-bottom" name="vagina" value="<?php echo $pengkajian_awal[0]->vagina; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <label for="Pendarahan">Pendarahan</label>
                                                            <input type="text" id="Pendarahan" class="form-control input-border-bottom" name="pendarahan" value="<?php echo $pengkajian_awal[0]->pendarahan; ?>">
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="Payudara" class="form-control input-border-bottom" name="payudara" value="<?php echo $pengkajian_awal[0]->payudara; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <textarea class="form-control" name="data_penunjang" id="data_penunjang" rows="4"><?php echo $pengkajian_awal[0]->data_penunjang; ?></textarea>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>

                                        ...
                                        <div class="row table-responsive">
                                            <table cellpadding="6" class="table-borderless border-start border-end border-top border-bottom">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo csrf();?>
                                                        <input type="hidden" class="form-control" name="pengkajian_awal_id" required="required" value="<?php echo $pengkajian_awal[0]->pengkajian_awal_id; ?>">
                                        ...
                                        <div class="row mt-4 table-responsive">
                                            <table cellpadding="5" class="table-borderless border-start border-end border-top border-bottom">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control input-border-bottom" name="abdomen_tambahan" value="<?php echo $pengkajian_awal[0]->abdomen_tambahan; ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="luka" class="form-control input-border-bottom" name="eks_fiksasi_tambahan" value="<?php echo $pengkajian_awal[0]->eks_fiksasi_tambahan; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td class="border-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="nyeri_e" class="form-control input-border-bottom" name="eks_fiksasi_tambahan" value="<?php echo $pengkajian_awal[0]->eks_fiksasi_tambahan; ?>">
                                                    </td>
                                                    <td></td>
                                                    <td class="border-start">
                                                        <div class="input-group">
                                                            <input type="checkbox" class="form-check-input form-check-primary form-check-glow">
                                                            <input type="text" class="form-control input-border-bottom" name="masalah_muskuloskeletal_tambahan" value="<?php echo $pengkajian_awal[0]->masalah_muskuloskeletal_tambahan; ?>">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>

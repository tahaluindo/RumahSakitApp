                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart("riwayat_kunjungan_pasien/update")?>
                                    <form class="form">
                                        ...
                                        <div class="row mt-4 table-responsive">
                                            <table cellpadding="5" class="table-borderless border-start border-end border-top border-bottom text-center">
                                                ...
                                                <tr>
                                                                ...
                                                                <?php
                                                                    foreach($poliklinik as $po){
                                                                        if($riwayat_kunjungan_pasien[0]->poliklinik_id == $po->poliklinik_id){
                                                                            echo '<option value="'.$po->poliklinik_id.'"selected>'.$po->nama_poliklinik.'</option>';
                                                                        }else{
                                                    ...
                                                    <td class="border-end">
                                                        <textarea class="form-control" name="subjektif" placeholder="Ketikkan sesuatu atau beri tanda '-' jika tidak ada data" rows="12"><?php echo $riwayat_kunjungan_pasien[0]->subjektif; ?></textarea>
                                                    </td>
                                                    <td class="border-end">
                                                        <textarea class="form-control" name="objektif" placeholder="Ketikkan sesuatu atau beri tanda '-' jika tidak ada data" rows="12"><?php echo $riwayat_kunjungan_pasien[0]->objektif; ?></textarea></td>
                                                    <td class="border-end">
                                                        <textarea class="form-control" name="assesment" placeholder="Ketikkan sesuatu atau beri tanda '-' jika tidak ada data" rows="12"><?php echo $riwayat_kunjungan_pasien[0]->assesment; ?></textarea></td>
                                                    <td class="border-end">
                                                        <textarea class="form-control" name="planning" placeholder="Ketikkan sesuatu atau beri tanda '-' jika tidak ada data" rows="12"><?php echo $riwayat_kunjungan_pasien[0]->planning; ?></textarea>
                                                    </td>
                                                    <td>

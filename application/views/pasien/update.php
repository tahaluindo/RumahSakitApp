                                ...
                                <form class="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="tempat_lahir" class="form-control" name="tempat_lahir" placeholder="tempat" required="required" value="<?php echo $pasien[0]->tempat_lahir; ?>">
                                        </div>
                                        <div class="col-md-2 form-group">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary btn-sm me-1 mb-1"><i class="bi bi-save2"></i> Simpan</button>
                                        <button type="reset" class="btn btn-light-secondary btn-sm me-1 mb-1"><i class="bi bi-x-square"></i> Reset</button>
                                    </div>
                                </form>
                                <?php echo form_close(); ?>
                            </div>
